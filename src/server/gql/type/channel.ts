...
builder.objectType("Channel", {
	fields: (t) => ({
		...
		// STATISTICS
		hiddenSubscriberCount: t.exposeBoolean("hiddenSubscriberCount"),
		subscriberCount: t.exposeFloat("subscriberCount"),
		videoCount: t.exposeFloat("videoCount"),
		viewCount: t.exposeFloat("viewCount"),
	}),
})
